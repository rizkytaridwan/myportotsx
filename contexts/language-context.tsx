...
const translations = {
  en: {
    ...
    "about.description1":
      "I am a professional who combines strong administrative skills with technical expertise in web development. As a certified Microsoft Office Specialist, I can transform complex data into strategic reports. Additionally, I build digital solutions like websites to enhance online presence and support sales.",
    "about.description2":
    ...
    "about.achievement1.desc": "Microsoft Office Specialist & Data Analysis Certified",
    ...
    "about.achievement3.desc": "99.9% accuracy rate with quality assurance protocols",
    ...
    "portfolio.project1.desc":
      "Digitized and organized 10,000+ product entries for a major e-commerce platform, including specifications, pricing, and inventory data.",
    "portfolio.project1.duration": "3 weeks",
    "portfolio.project1.client": "TechMart Solutions",
    "portfolio.project1.results": "99.8% accuracy, 40% faster product searches",
    "portfolio.project2.title": "Healthcare Records Digitization",
    "portfolio.project2.desc":
      "Converted 5,000+ patient records from paper to digital format while maintaining HIPAA compliance and data security.",
    "portfolio.project2.duration": "6 weeks",
    "portfolio.project2.client": "MediCare Plus",
    ...
    "contact.whyChoose.point1": "5+ years of professional experience",
    "contact.whyChoose.point2": "99.9% accuracy rate guaranteed",
  ...
  id: {
    ...
    "about.description1":
      "Saya seorang profesional yang menggabungkan keterampilan administrasi yang kuat dengan keahlian teknis dalam pengembangan web. Sebagai Microsoft Office Specialist bersertifikat, saya mampu mengubah data kompleks menjadi laporan strategis. Selain itu, saya membangun solusi digital seperti situs web untuk meningkatkan kehadiran online dan mendukung penjualan.",
    "about.description2":
    ...
    "about.achievement1.desc": "Microsoft Office Specialist & Bersertifikat Analisis Data",
    ...
    "about.achievement3.desc": "Tingkat akurasi 99.9% dengan protokol jaminan kualitas",
    ...
    "portfolio.project1.desc":
      "Mendigitalkan dan mengorganisir 10.000+ entri produk untuk platform e-commerce besar, termasuk spesifikasi, harga, dan data inventori.",
    "portfolio.project1.duration": "3 minggu",
    "portfolio.project1.client": "TechMart Solutions",
    "portfolio.project1.results": "Akurasi 99.8%, pencarian produk 40% lebih cepat",
    "portfolio.project2.title": "Digitalisasi Catatan Kesehatan",
    "portfolio.project2.desc":
      "Mengkonversi 5.000+ catatan pasien dari kertas ke format digital sambil mempertahankan kepatuhan HIPAA dan keamanan data.",
    "portfolio.project2.duration": "6 minggu",
    "portfolio.project2.client": "MediCare Plus",
    ...
    "contact.whyChoose.point1": "5+ tahun pengalaman profesional",
    "contact.whyChoose.point2": "Tingkat akurasi 99.9% terjamin",
