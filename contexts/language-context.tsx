...
const translations = {
  en: {
    ...
    "portfolio.project1.desc":
      "Digitized and organized 1,000+ product entries for a major e-commerce platform, including specifications, pricing, and inventory data.",
  ...
  id: {
    ...
    "portfolio.project1.desc":
      "Mendigitalkan dan mengorganisir 1.000+ entri produk untuk platform e-commerce besar, termasuk spesifikasi, harga, dan data inventori.",
